...
const RegistrationCard = ({
  ...
  return (
    <div
      className="relative overflow-hidden bg-white/70 backdrop-blur-sm rounded-2xl border border-white/50 transition-all duration-300 hover:scale-[1.02] animate-fade-in-up"
