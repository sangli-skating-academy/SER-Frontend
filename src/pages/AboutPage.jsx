  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="container py-12 m-auto"
      >
        <motion.div
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          ...
          >
            ...
            <p className="text-gray-700  mb-3">
              Our platform is built for the community, by the
              community—constantly evolving with your feedback and needs.
            </p>
            ...
            <div>
              {team.map((member, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="overflow-hidden h-full bg-white/8">
